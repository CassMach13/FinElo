-- Sprint 1A — exclusão exata e atômica de um lote pelo log selecionado.
-- Evita que dois lotes com o mesmo nome de arquivo apaguem dados um do outro.
...
begin
  ...
  if v_detail_id_count > 0 then
    ...
    if v_persisted_count <> v_detail_id_count then
      raise exception
